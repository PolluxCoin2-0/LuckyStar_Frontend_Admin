          ...
          {ManageUserData.map((data, index) => {
            return (
              ...
              >
                ...
                <div className="text-black  w-[20%] flex justify-center items-center space-x-4"><AiOutlineEye size={20} className="cursor-pointer" /> <MdDeleteOutline size={20} className="cursor-pointer" /></div>
